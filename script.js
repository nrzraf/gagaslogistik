  ...
  link.addEventListener('click', e => {
    ...
    const translations = {
      id: {
        ...
        "hero.db_tag": "Langsung",
        "hero.stat_1_label": "Kepatuhan Standar Armada",
        "hero.stat_2_label": "Armada Aktif",
        "hero.stat_3_label": "Efisiensi Rute",
        "hero.float_badge_1_title": "Sensor Suhu &amp; Armada",
        "hero.float_badge_1_sub": "Rute terkontrol · real-time",
        ...
        "services.card_3_desc": "Armada berpendingin khusus dengan kontrol suhu untuk produk beku, farmasi, &amp; makanan segar.",
        ...
        "solutions.land_desc": "Kami menggabungkan eksekusi transportasi dengan layanan manajemen transportasi untuk memenuhi segala kebutuhan Anda di jalan raya. Melalui jaringan pusat kendali dan teknologi mutakhir, kami memantau pengiriman di sepanjang rute serta memastikan kargo Anda selalu menempuh rute paling efisien. Solusi transportasi darat kami menyediakan berbagai tipe truk didukung suspensi udara (air suspension), pemantauan rute real-time, serta truk berpendingin (temperature controlled).",
        "solutions.tag_control_tower": "Pusat Kendali",
        "solutions.tag_monitoring": "Pemantauan Real-Time",
        "solutions.tag_air_susp": "Air Suspension",
        "solutions.tag_temp_ctrl": "Temperature Controlled",
        ...
        "stats.s2_sub": "Pemantauan armada & suhu real-time",
        ...
        "faq.a2": "Kami mengombinasikan eksekusi pengiriman dengan manajemen pusat kendali terpadu, armada bersuspensi udara (air suspension), pemantauan rute real-time, dan rute tercepat untuk efisiensi biaya maksimal.",
        ...
        "faq.a4": "Ya, kami menyediakan truk dengan pengatur suhu (temperature controlled) berteknologi tinggi untuk pengiriman produk beku, bahan farmasi, dan hasil pangan segar dengan pemantauan suhu real-time.",
        "faq.q5": "Bagaimana cara memantau status pengiriman kargo kami?",
        "faq.a5": "Seluruh armada terhubung dengan sistem telematika terpadu, memungkinkan pelacakan rute secara langsung dan penyampaian bukti pengiriman digital secara transparan.",
      ...
      en: {
        ...
        "hero.stat_2_label": "Active Fleet",
        "hero.stat_3_label": "Route Efficiency",
        "hero.float_badge_1_title": "Temp Sensor &amp; Telematics",
        "hero.float_badge_1_sub": "Controlled route · real-time",
        ...
        "services.card_3_title": "Cold Chain",
        "services.card_3_desc": "Specialized temperature-controlled refrigerated fleet for frozen goods, pharmaceuticals, &amp; fresh produce.",
        ...
        "solutions.land_title": "Land Transportation",
        "solutions.land_desc": "We combine transport execution with transport management services to meet all your needs on the road. Through our global network of operations centers and state-of-the-art technology, we monitor your shipments throughout their road journey and ensure your goods are always travelling on the most efficient route. Our road transport solution provides many truck types alongside a range of value added services including air suspension vehicles, real-time monitoring and temperature controlled trucks.",
        "solutions.tag_control_tower": "Operations Center",
        "solutions.tag_monitoring": "Real-Time Monitoring",
        "solutions.tag_air_susp": "Air Suspension",
        "solutions.tag_temp_ctrl": "Temperature Controlled",
        ...
        "stats.s2_label": "Real-Time Fleet Monitoring",
        "stats.s2_sub": "Real-time fleet & temp tracking",
        ...
        "faq.a2": "We combine transport execution with central operations management, air suspension vehicles, real-time monitoring, and optimized routes for accelerated delivery and cost reduction.",
        ...
        "faq.q4": "Do you provide temperature-controlled Cold Chain trucks?",
        "faq.a4": "Yes, we provide state-of-the-art temperature-controlled trucks for frozen goods, pharmaceuticals, and fresh produce with real-time temperature monitoring.",
        "faq.q5": "How can customers track their cargo status in real time?",
        "faq.a5": "Our entire fleet is connected to integrated telematics under central operations surveillance, offering live journey tracking and transparent digital proof of delivery.",
